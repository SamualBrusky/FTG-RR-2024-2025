 ...
 */
public class LiftSubmersibleSetupCmd extends CommandBase {
     ...
     */
    public LiftSubmersibleSetupCmd(LiftSubsystem subsystem) {
        m_Lift = subsystem;
    ...
    @Override
    public void execute() {
        m_Lift.setSetpoint(LiftSubsystem.ElevatorPosition.SUBMERSIBLE_SETUP_POSITION);
    }
